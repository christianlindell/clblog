...
Som jag skrev i början så är en sf-karta bara en vanlig dataframe med en ytterligare list-kolumn med geometriska data. Det innebär att geografin följer med när vi aggregerar data. Om vi aggregerar en dataframe med befolkningtal för kommuner upp till länsnivå så aggregeras även polygonerna!

Den tidigare skapade dataframen dfkom innehåller bland annat variablerna kom_kod och ant_sys. Vi kan använda dem för att ta fram en länskarta med befolkningssiffror:
