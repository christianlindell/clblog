...
Den här gången vill vi veta "Antal elever i förskoleklass i kommunal skola belägen i kommunen. Uppgiften avser läsår, mätt 15 oktober". Den här gången är koden för indikatorn "N11805".
...
url <- "http://api.kolada.se/v2/ou?"

```

## Lista alla enheter i hela riket

Man kan även ladda hem en tabell över alla enheter i riket. Tyvärr returneras endast de 5000 första träffarna.


```{r}

# Ladda hem uppgifter om de 5000 första enheterna i riket
url <- "http://api.kolada.se/v2/ou?"
...
#  3 V15E011400805 0114         Grimsta skola               
#  4 V15E011401201 0114         Bollstanäs skola            
#  5 V15E011401301 0114         Sverigefinska sk, Uppl Väsby
#  6 V15E011401601 0114         Breddenskolan               
#  7 V15E011402401 0114         Vittra Väsby                
#  8 V15E011402801 0114         Södervikskolan              
#  9 V15E011402901 0114         Odenskolan                  
# 10 V15E011403001 0114         Frestaskolan                
